...
print(IG_USERNAME)
print(IG_PASSWORD)
title = "Ultimate video complilation (MUST SEE) V1"
now = datetime.datetime.now()
videoDirectory = f"{os.getcwd()}/uploads"
...
def routine():
    ...
    description = "Enjoyed our video? \n\n" \
    "Make sure to visit our links below for a chance to feature your clip in our future videos!\n\n\n\n" \
    "Website: \n" \
    "Discord: https://discord.gg/6AatCrwQeR\n"
    ...
    description += "#sweep ai #sweeple #daniels #compilation #funny #funnyvideos \n\n"
